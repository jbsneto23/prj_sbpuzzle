...
class Solver
{
    public:
        ...
        * @param html_mode Flag que indica se o resultado das mensagens deve ser em ASCII ou em HTML.
        ...
        *
        * @param puzzle_file Nome do arquivo que contem as informações do quebra-cabeça.
        */
